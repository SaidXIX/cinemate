...
const HomeMovieSection = () => {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        ...
        let url = `https://api.themoviedb.org/3/discover/movie?language=${selectedLanguage}&page=${currentPage}&with_genres=${selectedGenre}&sort_by=${selectedSortBy}&primary_release_date.gte=${releaseDate}`

        if (searchTerm.trim() !== '') {
          url = `https://api.themoviedb.org/3/search/movie?language=${selectedLanguage}&query=${searchTerm}`
        }
  ...
  return (
    <VStack width='100%'>
      ...
      <Input onChange={handleSearchTermChange} value={searchTerm} placeholder='Search for a movie...' backgroundColor={useColorModeValue('lightMode.inputBackground', 'darkMode.inputBackground')}/>
                ...
                >
                  <Menu>
                    ...
                    <MenuList>
                      <MenuItem
                        onClick={() => {
                          handleAddToFavorites(show, 'movie')
                          toast({
                            title: 'Item Added',
                            description:
                      ...
                      <MenuItem
                        onClick={() => {
                          handleAddToWatchlist(show, 'movie')
                          toast({
                            title: 'Item Added',
                            description:
